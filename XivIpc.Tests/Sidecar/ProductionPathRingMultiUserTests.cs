...
public sealed class ProductionPathRingMultiUserTests
{
    ...
    public Task SecondaryUnixUser_CanConnect_ReadRing_AndReceivePublish_WhenEnabled()
        => Inner.SecondaryUnixUser_CanConnect_ReadRing_AndReceivePublish_WhenEnabled(ProductionPathTestEnvironment.RingBackendName);
}
