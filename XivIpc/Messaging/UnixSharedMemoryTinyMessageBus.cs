...
{
    internal sealed class UnixSharedMemoryTinyMessageBus : IXivMessageBus
    {
        ...
        public UnixSharedMemoryTinyMessageBus(ChannelInfo channelInfo)
        ...
        public void Dispose()
        {
            ...
            try { Task.WaitAll(new[] { _subscriberLoopTask, _dispatchLoopTask }, TimeSpan.FromSeconds(2)); }
            catch (Exception ex)
            {
